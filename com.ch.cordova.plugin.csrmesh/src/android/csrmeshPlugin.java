...
//			2017年5月18日  清空存储的所有已发现设备;即重新执行扫描过程
			mNewDevices.clear();
			Log.v("BLE","getAssociableDevice begin");
...
//			bindIntent.setAction("com.csr.mesh.MeshService");
...
//	                parentActivity.mService.setDeviceDiscoveryFilterEnabled(false);
	                parentActivity.newUuid(uuid.getUuid().toString(), uuidHash, rssi, ttl);//或者直接使用 mDevices.add();
